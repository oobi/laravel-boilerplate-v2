{{-- The Settings page body (team details form + ownership acts). Shared between the tabbed
     and untabbed layouts of the Settings page — see settings.blade.php. Expects $team and
     $showOwnership in scope; $this is the Settings Livewire component.
