@section('page-title', __('theme-demo::messages.tables_maximalist_title'))

<div class="flex flex-col gap-4">
    <x-page-header :title="__('theme-demo::messages.tables_maximalist_title')" :description="__('theme-demo::messages.tables_maximalist_description')" />
    ...
    @if (count($selected))
        <div class="ui-toolbar flex items-center justify-between">
