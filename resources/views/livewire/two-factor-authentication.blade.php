<div class="mx-auto flex max-w-2xl flex-col gap-6">
    ...
    @php
        $twoFactorTitle = match (true) {
            ! $this->enabled => __('admin.two_factor_not_enabled'),
            $showingConfirmation => __('admin.two_factor_finish_enabling'),
            default => __('admin.two_factor_enabled'),
        };
    @endphp

    <x-card :title="$twoFactorTitle">
