...
| `app/Enums/SystemPermission.php` | the four team permission cases (`manage teams`, `deactivate teams`, `delete teams`, `manage team ownership`), their `label()` arms and their `category()` arm (3 fenced blocks) | delete each block |
